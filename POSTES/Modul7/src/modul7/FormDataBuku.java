...
public class FormDataBuku extends javax.swing.JFrame {
    ...
    private void TampilData(){//method untuk menampilkan data
        try{
            ...
            while(rss.next()){                  //perulangan menggunakan while untuk menampilkan data pada tabel
                ...
                model.addRow(o);                    //mencetak pada tabel
            }
        }catch(SQLException e){
            System.out.println(e.getMessage());
        }
    }
    private void clear(){       //method ini berfungsi untuk menghapus table seluruh data pada method TampilData
    ...
    private void clears(int coun){      //method ini berfungsi untuk menghapus tabel hasil pencarian 
            for (int i = 0; i < coun; i++) {    //menggunakan variabel count untuk mencari jumlah baris dari hasil pencarian
